...
function getWebSiteAppsetting(webSiteClient, prisec, params, callback) {
    ...
    return webSiteClient.sites.listSiteAppSettings(resourceGroupName, websiteName, callback);
}
...
function configWebSiteAppsetting(webSiteClient, prisec, params, callback) {
    ...
    return webSiteClient.sites.updateSiteAppSettings(resourceGroupName, websiteName, appSettings, null, callback);
}